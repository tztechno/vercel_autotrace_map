    ...
    <script>
        ...
        console.log(`${selectElement.id} updated, new innerHTML:`, selectElement.innerHTML);
            ...
            function filterPoints() {
                ...
                console.log("Filtering with:", { selectedName, selectedDate, selectedHour });
                ...
                if (geojsonLayer) {
                    geojsonLayer.eachLayer(layer => {
                        ...
                        const hourMatch = selectedHour === '' || (properties && properties.hour.toString() === selectedHour);

                        console.log("Checking feature:", properties);
                        console.log("Matches:", { nameMatch, dateMatch, hourMatch });
